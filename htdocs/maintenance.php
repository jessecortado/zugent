...
<body class="bg-white p-t-0 pace-top">
	...
	<div id="page-container" class="vertical-center maintenance-bg">
		<div id="maintenance-content" class="container shadow">
			<div class="col-md-12">
				<img style="width: 17%; width:30vh; height:auto" src="assets/img/ruopen_banner2.jpg" alt="ZugEnt Marketing Website Logo">
				<p class="m-t-20">We're sorry but we are currently undergoing maintenance.</p>
