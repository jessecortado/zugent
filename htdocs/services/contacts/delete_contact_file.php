...
if(isset($_POST['contact_file_id'])){
	...
	add_user_log("Deleted a contact file (".$_POST['contact_file_id'].")", "contacts", array("importance" => "Info", "action" => "Delete") );
	...
	$sth3 = SQL_QUERY("select cf.*, cft.name as file_type_name from contact_files as cf 
		...
		where cf.contact_id=".SQL_CLEAN($_POST['contact_id'])." and cf.contact_file_id=".SQL_CLEAN($_POST['contact_file_id'])." and cf.is_deleted=1 limit 1");
