...
if(isset($_POST['contact_file_id'])){
	...
	// Add contact log (Restore)
	add_user_log("Restored a contact file (".$_POST['contact_file_id'].") for contact (".$_POST['contact_id'].")", "contacts", array("importance" => "Info", "action" => "Restore") );
