...
if(isset($_POST['transaction_status_id'])){
    ...
    // Add transaction log
	add_user_log("Changed a transaction date: date_modified=".$date." and transaction_status_id=".$_POST['transaction_status_id']." for transaction id (".$_POST['transaction_id'].")", "transaction", array("importance" => "Info", "action"=>"Update") );
