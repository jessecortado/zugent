...
if(isset($_POST['transaction_type_id'])){
    ...
    // Add transaction log
	add_user_log("Changed a transaction date: date_modified=".$date." and transaction_type_id=".$_POST['transaction_type_id']." for transaction id (".$_POST['transaction_id'].")", "transaction", array("importance" => "Info", "action"=>"Update") );
