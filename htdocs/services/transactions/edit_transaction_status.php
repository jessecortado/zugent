...
if(isset($_POST['transaction_status_id'])){
	...
	$sth = SQL_QUERY("update transaction_status set transaction_status='".SQL_CLEAN($_POST['transaction_status'])."' where transaction_status_id=".SQL_CLEAN($_POST['transaction_status_id']));
	
    // Add transaction log
	add_user_log("Changed a transaction date: date_modified=".$date." and transaction_status_id=".$_POST['transaction_status_id'], "transaction", array("importance" => "Info", "action"=>"Update") );
