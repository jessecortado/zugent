...
if(isset($_POST['transaction_type_id'])){
	...
	$sth = SQL_QUERY("update transaction_type set transaction_type='".SQL_CLEAN($_POST['transaction_type'])."' where transaction_type_id=".SQL_CLEAN($_POST['transaction_type_id']));
	// Add transaction log
	add_user_log("Changed a transaction date: date_modified=".$date." and transaction_type_id=".$_POST['transaction_type_id'], "transaction", array("importance" => "Info", "action"=>"Update") );
