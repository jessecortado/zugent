...
<head>
	<meta charset="utf-8" />
	<title>RUOPEN | Billing Purchase</title>
...
<body>
    ...
    <div id="page-container" class="fade in">
        ...
        <div class="login bg-black animated fadeInDown">
            <!-- begin brand -->
            <div class="login-header hidden-print" style="left:45%;width: 650px;"">
                <div class="brand text-center">
                    Thank you! Your balance has been paid.
                    <small>Your License has been renewed.</small>
                </div>
            </div>
            <!-- end brand -->
