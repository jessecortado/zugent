...
<head>
  ...
  <title>{$event.event_subject}</title>
	...
	<style type="text/css">
        ...
        ********************************/
      {literal}body{background:#d9e0e7}a:hover,a:focus{text-decoration:underline}body,table.body,p,td{font-size:12px}h1,h2,h3,h4{margin:5px 0 10px}h5,h6{margin:5px 0}h1{font-size:36px}h2{font-size:30px}h3{font-size:24px}h4{font-size:18px}h5{font-size:14px}h6{font-size:12px}h1.last,h2.last,h3.last,h4.last,h5.last,h6.last,p.last{margin-bottom:0}td.last{padding-bottom:0!important}td.wrapper{padding:15px 15px 0}table.columns td,table.column td{padding:0 0 15px}.header,.footer{background:#fff}.content.dark-theme{background:#ffffff}.content.dark-theme .panel{background:#1b2024;border:none}.content.dark-theme h1,.content.dark-theme h2,.content.dark-theme h3,.content.dark-theme h4,.content.dark-theme h5,.content.dark-theme h6,.content.dark-theme .highlight{color:#000!important}.content.dark-theme a,a{color:#ffffff}.content.dark-theme p,.content.dark-theme td{color:#000000!important}.divider{height:1px;width:100%;background:#000;margin-top:5px}.text-right{text-align:right}.valign-middle{vertical-align:middle}.m-t-0{margin-top:0!important}.m-t-5{margin-top:5px!important}.m-t-10{margin-top:10px!important}.m-t-15{margin-top:15px!important}.m-b-0{margin-bottom:0!important}.m-b-5{margin-bottom:5px!important}.m-b-10{margin-bottom:10px!important}.m-b-15{margin-bottom:15px!important}.p-t-0{padding-top:0!important}.p-t-5{padding-top:5px!important}.p-t-10{padding-top:10px!important}.p-t-15{padding-top:15px!important}.btn a,.button a{color:#fff!important;font-weight:400!important;text-decoration:none!important}table.btn td,table.button td{vertical-align:middle!important;padding:6px 18px!important;background:#00acac!important;border-color:#00acac!important}table.btn:hover td,table.button:hover td,table.btn:visited td,table.button:visited td,table.btn:active td,table.button:active td{background:#008a8a!important;border-color:#008a8a!important}table.btn.orange td,table.button.orange td{background:#f59c1a!important;border-color:#f59c1a!important}table.btn.orange:hover td,table.button.orange:hover td,table.btn.orange:visited td,table.button.orange:visited td,table.btn.orange:active td,table.button.orange:active td{background:#c47d15!important;border-color:#c47d15!important}table.btn.blue td,table.button.blue td{background:#348fe2!important;border-color:#348fe2!important}table.btn.blue:hover td,table.button.blue:hover td,table.btn.blue:visited td,table.button.blue:visited td,table.btn.blue:active td,table.button.blue:active td{background:#2a72b5!important;border-color:#2a72b5!important}table.btn.red td,table.button.red td{background:#ff5b57!important;border-color:#ff5b57!important}table.btn.red:hover td,table.button.red:hover td,table.btn.red:visited td,table.button.red:visited td,table.btn.red:active td,table.button.red:active td{background:#cc4946!important;border-color:#cc4946!important}table.btn.white td a,table.button.white td a{color:#333!important}table.btn.white td,table.button.white td{background:#fff!important;border-color:#fff!important}table.btn.white:hover td,table.button.white:hover td,table.btn.white:visited td,table.button.white:visited td,table.btn.white:active td,table.button.white:active td{background:#e2e7eb!important;border-color:#e2e7eb!important}table.btn.grey td,table.button.grey td{background:#348fe2!important;border-color:#348fe2!important}table.btn.grey:hover td,table.button.grey:hover td,table.btn.grey:visited td,table.button.grey:visited td,table.btn.grey:active td,table.button.grey:active td{background:#929ba1!important;border-color:#929ba1!important}@media only screen and (max-width: 600px){.body .container.content{width:100%!important}table[class="body"] .wrapper{padding-right:15px!important}.text-right{text-align:left!important}}{/literal}
	</style>
</head>
<body>
<!-- begin page body -->
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        {if $company.0.allow_agents_email_logo eq 1}
                                                            {if $agent.url_email_logo ne ''}
                                                            <a href="#"><img src="{$agent.url_email_logo}" height="50px"/></a>
                                                            {else}
                                                                {if $company.0.url_email_logo ne ''}
                                                                <a href="#"><img src="{$company.0.url_email_logo}" height="50px"/></a>
                                                                {else}
                                                                <a href="https://ruopen.com/"><img src="https://dev-crm.ruopen.com/assets/img/ruopen_banner2.jpg?a=1" style="width: 80%;height:auto;" /></a>
                                                                {/if}
                                                            {/if}
                                                        {else}
                                                            {if $company.0.url_email_logo ne ''}
                        ...
                        <td>
                            ...
                            <table class="row">
                                <tr>
                                    <!-- begin wrapper -->
                                    <td class="wrapper">
                                        {if $agent.is_profile_photo ne 0}
                                        <img src="https://s3-us-west-2.amazonaws.com/zugent/profilephotos/{$agent.user_id}/original.jpg" height="100px" style="border-radius: 50%;"/>
                                        {else}
                                        <img src="https://ruopen.com/assets/img/user-0.jpg" height="100px" style="border-radius: 50%;" />
                                        {/if}
                                    </td>
                                    <td class="wrapper">
                                        <h4>{$agent.first_name} {$agent.last_name}</h4>
                                        <p class="m-b-5">{$company.0.company_name}</p>
                                        <p class="m-b-5">{$agent.email}</p>
                                        {if $agent.phone_mobile ne ''}<p class="m-b-5">Mobile: {$agent.phone_mobile}</p>{/if}
                                        {if $agent.phone_office ne ''}<p class="m-b-5">Office: {$agent.phone_office}</p>{/if}
                                    </td>
                                    <!-- end wrapper -->
                                </tr>
                            </table>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            <table class="eight columns">
                                                <tr>
                                                    <td>
                                                        <p>{$company.0.company_name}, {$company.0.street_address}. {$company.0.city}, {$company.0.state}. {$company.0.zip}</p>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="four columns">
                                                <tr>
                                                    <td class="wrapper text-right valign-middle">
                                                        <a href="{$unsubscribe_link}">To unsubscribe click here</a>
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
                                            </table>
