            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="social">
                    ...
                    <div class="social-list">
                        ...
                        {if $company_settings.gmail ne ''}<a href="https://plus.google.com/u/0/{$company_settings.gmail}"><i class="fa fa-instagram"></i></a>{/if}
                        {if $company_settings.instagram ne ''}<a href="https://www.instagram.com/{$company_settings.instagram}"><i class="fa fa-google-plus"></i></a>{/if}
                    </div>
                </div>
                <!-- END social -->
            </div>
...
<div id="footer" class="footer">
    ...
    <div class="container">
        ...
        <div class="row">
            <!-- BEGIN col-3 -->
            <div class="col-md-3" data-type="about-us" data-title="About Us">
            ...
            <!-- BEGIN col-3 -->
            <div class="col-md-3">
                <h4 class="footer-header">LATEST PROPERTY</h4>
...
<div id="footer-copyright" class="footer-copyright">
    <!-- BEGIN container -->
    <div class="container">
        <div class="copyright" data-type="footer-text" data-title="Footer Text">
            <div class="edit-block">
                <a class="setup"><i class="fa fa-pencil"></i></a>
                <div class="view">
                ...
                {else}
                Copyright &copy; 2017 Zugent. All rights reserved.
                {/if}
                </div>
            </div>
        </div>
